        <div class="col-lg-9" style="border-color: black">
         <center><h3 style="margin-top: -150px;">Persyaratan Pendaftaran</h3></center>
          <table >
            <tr>
                <td >
                  <a href="#"><button type="button" class="btn btn-success" style="margin-bottom: 20px; margin-top: 40px;margin-left: 0px;">Download Berkas</button></a>
                </td>
            </tr>
              <tr>
                  <td>
                  <textarea style="width: 900px; height: 600px; margin-bottom: 200px;">Usia
