...
--
-- Host: 127.0.0.1
-- Generation Time: 21 Mar 2018 pada 15.33
...
INSERT INTO `data_kesehatan` (`nisn`, `nama_dokter`, `rumah_sakit`, `penyakit_jantung`, `penyakit_kanker`, `penyakit_kelainan_psikologis`, `kelainan_saraf`, `kelainan_darah`, `pernah_operasi`, `masa_pengobatan`, `bantuan_medis`, `perhatian_fisik`) VALUES
('90', NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL);
...
--
-- Dumping data untuk tabel `data_ortu_a`
--

INSERT INTO `data_ortu_a` (`id_orangtua`, `nama`, `tanggal_lahir`, `tempat_lahir`, `no_ktp`, `gender`, `alamat`, `no_telp`, `status`, `pendidikan_terakhir`, `status_pekerjaan`, `jenis_pekerjaan`, `nama_perusahaan`, `jabatan`, `tahun_mulai_kerja`, `penghasilan`, `nisn`) VALUES
(1, '', '', '', 0, 'pria', '', '', 'ayah_kandung', '', '', '', '', '', '', '', '90'),
(2, '', '', '', 0, 'wanita', '', '', 'ibu_kandung', '', '', '', '', '', '', 'ssc', '90');
...
--
-- Dumping data untuk tabel `data_raport`
--
